...
import { Modal, Textarea, Button as MantineButton } from "@mantine/core";
...
const ScheduleModal = ({ opened, onClose, slot, mentor, note, isSubmitting, handleChange, handleSubmit }: ScheduleModalProps) => {
