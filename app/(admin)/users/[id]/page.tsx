        ...
        <div className="py-10 lg:px-7 px- ">
            ...
            <div className="lg:flex block  lg:mb-0  gap-y-5 rounded-2xl bg-white shadow-sm py-5 lg:px-14 px-5 w-full items-center">
                <div className="flex lg:mr-20  mb-7  items-center justify-center">
                    <img src={user?.profile?.profileImage || "/images/profile.jpg" } className='h-20 w-20 mr-3 rounded-full object-cover' alt="" />
                ...
                <div className='flex justify-between flex-wrap flex-1 gap-x-5 gap-y-3'>
                    <div className="">
                        ...
                        <div className="font-medium xl:text-xl text-lg">{user?.projects?.length}</div>
                    </div>
                    <div className="">
                        <div className="text  flex text-[#16181B80]">Email <FaRegCopy className='ml-2' /></div>
                        <div className="font-medium  text"> {user?.profile?.email} </div>
                    </div>
                    <div className="">
                        <div className="text text-[#16181B80]"> Role </div>
                        <div className="font-medium xl:text-lg text-lg">{formatTextToSentenceCase(user?.profile?.skills_of_interest[0] || '') }</div>
                    </div>
                    <div className="">
            ...
            <div className="lg:flex lg:mt-5 mt-5 gap-x-5 ">
                <div className="lg:w-2/5  rounded-xl bg-white py-7 px-4">
                    ...
                    <div className="flex gap-x-3 mt-3 mb-10">
                        ...
                        <div className="flex rounded-full justify-center bg-[#EFF3FF] border border-[#0234B8] items-center bg h-8 w-8"> <FaFacebookF color="#0234B8" className='cursor-pointer' /></div>
                        <div className="flex rounded-full justify-center bg-[#EFF3FF] border border-[#0234B8] items-center bg h-8 w-8"><BsTwitterX color="#0234B8" className='cursor-pointer' /></div>
                    </div>

                    <div className='flex items-center'>
                        <div className="text-[#16181B80] mr-5">Profile Photo: </div>
                        <img src={user?.profile?.profileImage || "/images/profile,jpg"} className='h-14 border w-14 mr-3 rounded-full object-cover' alt="" />
                    </div>
                    ...
                    <div className="flex border-b ">
                        {tabs.map((item, idx) =>
                            <div
                                ...
                                className={`${item.isActive ? 'border-b-4 rounded-b  border-[#001D69]  rouded-md' : "text-[#16181B80]"} px-5 py-2 cursor-pointer`}
                            >
                                {item.label}
                            </div>
                        )}
