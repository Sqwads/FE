...
import ArchivedBlogCard from './ArchivedBlogCard';
...
const ArchivedBlogGrid: React.FC = () => {
  const archivedBlogPosts: BlogPost[] = [
    {
      id: 1,
...
export default ArchivedBlogGrid;