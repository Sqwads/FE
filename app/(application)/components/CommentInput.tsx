  ...
  return (
    <div className="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
      <textarea
        ...
        className="w-full p-2 border h-40 border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-y mb-3"
        rows={6}
      />
